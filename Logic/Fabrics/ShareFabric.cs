...
namespace Logic.Fabrics
{
    ...
    {
        IEnumerable<Share> GetEntitiesOfCompany(long companyId, int count, double price);
    }
    ...
    public class ShareFabric : FabricBase<Share>, IShareFabric
    {
        ...
        public IEnumerable<Share> GetEntitiesOfCompany(long companyId, int count, double price)
        {
            IEnumerable<Share> shares = base.GetEntities(count);
            foreach (Share share in shares)
            {
                share.CompanyId = companyId;
                share.OwnerId = companyId;
